...
//neko
var neko={data:{timers:[],settings:{}}};$(function(){neko.init()}),neko.init=function(){$("#reminder-submit").on("click",neko.submit),"default"===Notification.permission&&Notification.requestPermission(),neko.ticker=new interval(neko.tick,100),window.addEventListener("blur",function(){$("#reminder-onblur-setting").prop("checked")&&neko.ticker.running&&(neko.ticker.end(),neko.ticker.time=1e3*+$("#reminder-blurmode-interval").val(),neko.ticker.start())}),window.addEventListener("focus",function(){100!=neko.ticker.time&&(neko.ticker.end(),neko.ticker.time=100,0<neko.data.timers.length&&neko.ticker.start())}),$("#timer-area").sortable({containment:"#timer-area"}),neko.loadStorage()},neko.submit=function(){let a=tagsInputRead($("#reminder-number")[0]),b=0,c=$("#reminder-note").val().replace("<","&lt;").replace(">","&gt;"),d=Date.now();if(!(1>a.length)){for(let c in a)/^([0-9]+)(h|hr|m|min|s|sec)$/g.test(a[c])?b+=interval.prototype.convert(a[c]):/^[0-9]+$/g.test(a[c])&&(b+=interval.prototype.convert(a[c]+"s"));0==b||(b+=d,neko.createTimer({target:b,note:c,startedAt:d}),toastr.success("Created Timer &quot;"+(c||"Untitled Timer")+"&quot;","Created Timer"),neko.ticker.start())}},neko.createTimer=function(a){let b,c=a.startedAt;b=new Date(a.target),(a.note===void 0||""===a.note)&&(a.note="Untitled Timer"),a.lastTick===void 0&&(a.lastTick=c),a.id===void 0&&(a.id=c.toString(16)),a.status="running",el=$("<div>",{id:a.id,class:"timer"}),el.append($("<button>").html("X").on("click",function(){let b=neko.data[a.id],c=$("#"+b.id);if("running"==b.status){if(0<c.find(".confirm-box").length)return;let a=$("<div/>",{class:"confirm-box"});return a.html("Do you really want to delete &quot;"+b.note+"&quot;?<br><br>").append($("<button/>").html("Yes").on("click",function(){neko.removeTimer($(this).parent().parent().attr("id"))})).append($("<button/>").html("No").on("click",function(){$(this).parent().remove()})),void c.append(a)}neko.removeTimer(b.id)}.bind(a))),el.append($("<h2>").html(a.note)),el.append($("<div>",{class:"progress"}).append($("<div>",{class:"progress-value"}).css("width","0%").html("0%"))),el.append($("<span>",{class:"small"}).html("Ends in <span>"+neko.timeFromMilliseconds(a.target-a.lastTick)+"</span> (at "+b.toLocaleTimeString()+")")),$("#timer-area").append(el),neko.data.timers.push(a.id),neko.data[a.id]=a,neko.updateStorage()},neko.removeTimer=function(a){neko.data.timers.splice(neko.data.timers.indexOf(a),1),delete neko.data[a],$("#"+a).remove(),neko.updateStorage()},neko.tick=function(){if(1>neko.data.timers.length)return void neko.ticker.end();for(let a of neko.data.timers){let b=neko.data[a];if("running"!=b.status)continue;let c=Date.now(),d=100*((c-b.startedAt)/(b.target-b.startedAt)),e=$("#"+a).find(".progress-value"),f=c-b.lastTick;if(b.lastTick=c,$("#"+a).find("span.small > span").html(neko.timeFromMilliseconds(b.target-c)),100<=d)return e.css("width","100%").html("100%").addClass("progress-finished"),b.status="finished",new Notification("Your Timer \""+b.note+"\" ended!"),void toastr.info("Timer &quot;"+b.note+"&quot; ended","Timer ended");e.css("width",d.toString()+"%").html((0|d).toString()+"%")}neko.updateStorage()},neko.timeFromMilliseconds=function(a){let b=Math.ceil(+a/1e3),c=!1,d="";if(0>b&&(b=0),3600<=b){let a=0|b/3600;b-=3600*a,d+=(10>a?"0":"")+a.toString()+":",c=!0}if(c||60<=b){let a=0|b/60;b-=60*a,d+=(10>a?"0":"")+a.toString()+":"}else d+="00:";return d+=(10>b?"0":"")+b.toString(),d},neko.updateStorage=function(){$("#reminder-allow-cookie")[0].checked?(neko.data.settings.cookieEnabled="enabled",neko.data.settings.blurModeEnabled=$("#reminder-onblur-setting").prop("checked")?"enabled":"disabled",neko.data.settings.blurModeInterval=+$("#reminder-blurmode-interval").val(),localStorage.setItem("nekoreminder",JSON.stringify(neko.data))):localStorage.clear()},neko.loadStorage=function(){let a=localStorage.getItem("nekoreminder");if(null===a)return!1;a=JSON.parse(a),$("#reminder-allow-cookie").prop("checked",!0),"enabled"===a.settings.blurModeEnabled&&$("#reminder-onblur-setting").prop("checked",!0),$("#reminder-blurmode-interval").val(a.settings.blurModeInterval);let b=a,c=b.timers;for(let a of c){let c=b[a];neko.createTimer(c),toastr.success("Loaded Timer &quot;"+c.note+"&quot; from cookies.","Loaded Timer")}0<c.length&&neko.ticker.start()},toastr.options={closeButton:!0,debug:!1,newestOnTop:!0,progressBar:!0,positionClass:"toast-top-right",preventDuplicates:!1,onclick:null,showDuration:"300",hideDuration:"1000",timeOut:"5000",extendedTimeOut:"1000",showEasing:"swing",hideEasing:"linear",showMethod:"fadeIn",hideMethod:"fadeOut"};